...
# Uncomment lines below when you have read in the proper outcome data files

# my_state <- ""   # enter your own state here
# my_county <- "" # enter your own county here
# 
# my_state_bounds <- 
#   get_acs(
#     geography = "county",
...
# tibble(
#   outcomes_to_explore = 
#     unique(c(names(county_outcomes_ez), names(ct_outcomes_ez)))
# ) %>% 
#   mutate(
#     rid = str_detect(outcomes_to_explore, "pooled")
#   ) %>% 
#   filter(
#     rid == FALSE, 
#     !(outcomes_to_explore %in% c("state", "tract", "county"))
#   ) %>% 
#   select(outcomes_to_explore)
```
